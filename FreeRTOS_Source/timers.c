...
static const size_t xBlockAllocatedBit = ( ( size_t ) 1 ) << ( ( sizeof( size_t ) * heapBITS_PER_BYTE ) - 1 );
...
static void prvCheckForValidListAndQueue( void )
{
	...
	taskENTER_CRITICAL();
	{
		if( xTimerQueue == NULL )
		{
			...
			{
		        ///////Check begin
		        uint8_t *puc = ( uint8_t * ) xTimerQueue;
		        BlockLink_t *pxLink;
		        ...
		        if(!(allocbit == 0 || pxLink->pxNextFreeBlock != NULL))
		            vPortFree(xTimerQueue);
